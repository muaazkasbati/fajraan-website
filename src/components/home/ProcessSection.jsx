                            ...
                            <div className="section-block text-center lg:text-start">
                                ...
                                <div className="jos mt-6">
                                    <p className="section-para">
                                        We prioritize transparent communication and collaboration at every stage, ensuring that your project aligns perfectly with your business goals.
                                    </p>
                                    <p className="section-para">
                                        While the steps below outline our typical workflow, we tailor our approach to fit the unique needs and complexity of each project.
                                    </p>
                                </div>
                            </div>
