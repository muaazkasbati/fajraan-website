            ...
            {contactPage ?
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-y-6">
                    <input
                        ...
                        className="w-full rounded-[50px] border border-[#cccccc] bg-transparent px-6 py-5 text-base font-bold leading-none outline-0 text-white placeholder:text-[#cccccc]"
                        required
                    />
                    <input
                        type="email"
                    ...
                    <textarea
                        ...
                        className="min-h-[150px] w-full rounded-[20px] border border-[#cccccc] bg-transparent px-6 py-5 text-base font-bold leading-none outline-0 text-white placeholder:text-[#cccccc]"
                        required
                    ></textarea>
