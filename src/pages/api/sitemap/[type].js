const staticRoutes = [
  ...
  { url: `${process.env.NEXT_PUBLIC_APPFRONTURL}services/cloud-devops-solutions`, lastmod: new Date().toISOString(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${process.env.NEXT_PUBLIC_APPFRONTURL}services/ai-automation`, lastmod: new Date().toISOString(), changeFrequency: 'monthly', priority: 0.7 },
  { url: `${process.env.NEXT_PUBLIC_APPFRONTURL}services/cybersecurity-it-support`, lastmod: new Date().toISOString(), changeFrequency: 'monthly', priority: 0.7 },
