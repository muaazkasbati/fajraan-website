const staticRoutes = [
  ...
  { path: 'chauffeur-software', changefreq: 'monthly', priority: 0.7 },
  { path: 'case-studies/empire-chauffeurs-australia', changefreq: 'monthly', priority: 0.7 },
  ...
  { path: 'services/ai-automation-ai-chatbot', changefreq: 'monthly', priority: 0.7 },
